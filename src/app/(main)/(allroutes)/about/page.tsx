  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        >
          <h2 className="text-xl font-semibold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500">
            Welcome to EasyRAG
          </h2>
          <p className="text-sm leading-relaxed">
            At EasyRAG, we empower your data journey with cutting-edge tools and
            technologies designed to enhance your chatbot experience. Our
            mission is to democratize data accessibility by offering an
            easy-to-use platform that allows you to create custom chatbots with
            industry-standard customizations, all without breaking the bank.
          </p>
        </motion.section>
        ...
        >
          <h2 className="text-xl font-semibold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500">
            Our Story
          </h2>
          <p className="text-sm leading-relaxed">
            ...
            and powerful platform. Whether you are tired of rate limits or
        ...
        >
          <h2 className="text-xl font-semibold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-500">
            What We Do
          </h2>
          <p className="text-sm leading-relaxed">
        ...
        >
          <h2 className="text-xl font-semibold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-pink-500">
            Our Features
          </h2>
          <ul className="list-none space-y-2 text-sm">
            ...
            <li className="flex items-center">
              <span className="mr-2 text-base">🔌</span>
              <span>
                Versatile Integration: Generate a website embedding to insert
                your custom chatbot into your site seamlessly.
              </span>
            </li>
            <li className="flex items-center">
              <span className="mr-2 text-base">🚀</span>
        ...
        >
          <h2 className="text-2xl  font-semibold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">
            Join Us
          </h2>
          ...
          <p className="text-sm leading-relaxed mb-4">
            ...
            EasyRAG, we are not just creating tools — we are building a
